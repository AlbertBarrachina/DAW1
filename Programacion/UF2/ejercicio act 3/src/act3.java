...
public class act3 {
	...
	static int[] respuesta(String frase) {
		String vocales = "aeiouàáèéìíòóùúäëïöüAEIOUÀÁÈÉÌÍÒÓÙÚÄËÏÖÜ";
		...
		for (int n = 0; n < texto.length; n++) {
			// comprueba espacios (posicion 5)
			if (texto[n] == ' ') {
				respuesta[5]++;
			} else {
				//comprueba vocales (posicion 1)
