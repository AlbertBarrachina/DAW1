...
public class loteria {
	...
	public static void main(String[] args) {
		...
		while (otro) {
			...
			// el siguiente while es un sort de bubble para ordenar los numeros ganadores de
			// menor a mayor
			while (y < ganador.length) {
			...
			// output
			System.out.println("Numeros elejidos :" + numeros[0] + " " + numeros[1] + " " + numeros[2] + " "
					+ numeros[3] + " " + numeros[4] + " " + numeros[5]);

			System.out.println("Numeros ganadores :" + ganador[0] + " " + ganador[1] + " " + ganador[2] + " "
					+ ganador[3] + " " + ganador[4] + " " + ganador[5]);

			while (n < numeros.length) {// comprueba cuantos numeros has acertado
			...
			letra = teclado.next().charAt(0);// te pide una letra (s o n) y reinicia el progama si dices 's'
			if ('S' == letra || 's' == letra) {
				otro = true;
				i = 0;
				y = 0;
