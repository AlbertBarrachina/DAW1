								...
								if (tb[fila - 1][0] == 1 && tb[fila - 1][1] == 1 && tb[fila - 1][2] == 1) {
									...
									for (i = 0; i == 0;) {// moviments predeterminats
										if (tb[2][2] == 0) {
											...
											fila = 3;
											columna = 3;
										} else if (tb[0][0] == 1 && tb[1][1] == 1 && tb[2][2] == 2 && tb[2][0] == 0) {
											fila = 3;
											columna = 1;
										} else if (tb[0][0] == 1 && tb[2][2] == 1 && tb[1][1] == 0) {
											fila = 2;
											columna = 2;
										} else if (tb[1][1] == 1 && tb[2][2] == 1 && tb[0][0] == 0) {
											fila = 1;
											columna = 1;
										} else if (tb[1][1] == 1 && tb[2][2] == 1 && tb[0][0] == 2 && tb[2][0] == 0) {
											fila = 1;
											columna = 2;
										} else if (tb[0][2] == 1 && tb[1][1] == 1 && tb[2][0] == 0) {
											fila = 3;
											columna = 1;
										} else if (tb[0][2] == 1 && tb[1][1] == 1 && tb[2][0] == 1 && tb[0][0] == 0) {
											fila = 1;
											columna = 1;
										} else if (tb[0][2] == 1 && tb[2][0] == 1) {
											fila = 2;
											columna = 2;
										} else if (tb[1][1] == 1 && tb[2][0] == 1 && tb[0][2] == 0) {
											fila = 1;
											columna = 3;
										} else if (tb[1][1] == 1 && tb[2][0] == 1 && tb[0][2] == 2 && tb[2][2] == 0) {
											fila = 3;
											columna = 3;
										} else if (tb[1][1] == 1 && tb[0][2] == 1 && tb[2][0] == 0) {
											fila = 3;
											columna = 1;
										} else if (tb[1][1] == 1 && tb[0][2] == 1 && tb[2][0] == 2 && tb[2][2] == 0) {
											fila = 3;
											columna = 3;
