	...
	public static void main(String[] args) {
		...
		while (repetir == 0) {
			...
			if (ejercicio == 1) {// enunciado 1
				...
				System.out.println("¿Cuatos numero quieres introducir?");
				m = teclado.nextInt();
				n = 0;
				y = 0;
				i = 0;
				...
				do {
					System.out.println("Qieres ordenar los numeros? (no:1 si:2)");
					x = teclado.nextInt();
				} while (x != 1 && x != 2);
				while (i < m) {
					n = 0;
				...
				System.out.println("Enunciado en construccion (╥﹏╥)");
